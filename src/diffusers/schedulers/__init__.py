...
try:
    ...
    _import_structure["scheduling_cosine_dpmsolver_multistep_inverse"] = ["CosineDPMSolverMultistepInverseScheduler"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .scheduling_cosine_dpmsolver_multistep_inverse import CosineDPMSolverMultistepInverseScheduler
