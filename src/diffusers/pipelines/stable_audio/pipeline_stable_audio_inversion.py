...
from ...schedulers import CosineDPMSolverMultistepInverseScheduler
from ...utils import (
...
class StableAudioInversionPipeline(DiffusionPipeline):
    r"""
    ...
    def __init__(
        ...
        transformer: StableAudioDiTModel,
        scheduler: CosineDPMSolverMultistepInverseScheduler, # EDMDPMSolverMultistepScheduler default CosineDPMSolverMultistepScheduler  CosineDPMSolverMultistepInverseScheduler
    ):        
        super().__init__()
